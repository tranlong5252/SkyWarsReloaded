...
public class PlayerManager {
    ...
    private void removeWaitingPlayer(final Player playerRemoved, UUID pUuid, GameMap gameMap, PlayerData playerData, PlayerRemoveReason removeReason, boolean announceToOthers) {
